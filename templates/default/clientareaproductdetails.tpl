    ...
    <div class="row">
        ...
        <div class="col30">
            <div class="internalpadding">
                ...
                <p>Here is an overview of your product/service with us.</p>
                <br />
                <p><input type="button" value="Back to Services List" class="btn" onclick="window.location='clientarea.php?action=products'" /></p>
            </div>
        </div>
        <div class="col70">
            <div class="internalpadding">
                ...
                {if $dedicatedip}<p><h4>{$LANG.domainregisternsip}:</h4> {$dedicatedip}</p>{/if}
    ...
    <div class="row">
        ...
        <div class="col30">
            <div class="internalpadding">
                ...
                <p>From here you can change the password of the product/service (note: this does not affect your password for our client area)</p>
            </div>
        </div>
        <div class="col70">
            <div class="internalpadding">
