...
<div id="tabs">
    <ul class="tabs">
        ...
        <li><a href="#tab3">{$LANG.domainnameservers}</a></li>
    ...
    <div class="row">
        ...
        <div class="col30">
            <div class="internalpadding">
                ...
                <br />
                <p><input type="button" value="Back to Domains List" class="btn" onclick="window.location='clientarea.php?action=domains'" /></p>
            </div>
        </div>
        <div class="col70">
            <div class="internalpadding">
                ...
                <p><form method="post" action="cart.php?gid=renewals"><h4><strong>{$LANG.recurringamount}:</strong></h4> {$recurringamount} Every {$registrationperiod} {$LANG.orderyears}{if $renew} &nbsp;&nbsp; <input type="hidden" name="domainid" value="{$domainid}" /><input type="submit" value="Renew Now" class="btn" />{/if}</form></p>
...
<div id="tab4" class="tab_content">
    ...
    <div class="row">
        ...
        <div class="col70">
            <div class="internalpadding">
                <p><h4><strong>Registrar Lock Status:</strong></h4></p>
                ...
                <p><input type="submit" class="btn danger" value="Disable Registrar Lock" /></p>
                {else}
                <p><input type="submit" name="reglock" class="btn success" value="Enable Registrar Lock" /></p>
                {/if}
                </form>
            </div>
        </div>
